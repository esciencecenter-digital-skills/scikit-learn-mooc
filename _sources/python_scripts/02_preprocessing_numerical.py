...
# %% [markdown]
# Using a few variables to represent the general idea, let's look at the data types
# of these variables:
...
# %% [markdown]
# The two types are integer `int64` and `object`. We can look at the first few lines
# of the dataframe to understand the meaning of the `object` data type.
