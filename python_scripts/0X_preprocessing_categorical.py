...
# TODO: this should come after we introduce cross-validation; should it be an exercise?
# However, some context is necessary to explain the options `handle_unknown`
#
